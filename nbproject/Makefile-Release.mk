...
${OBJECTDIR}/ITA.o: ITA.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -fast -g -KPIC  -o ${OBJECTDIR}/ITA.o ITA.c

${OBJECTDIR}/FMCode.o: FMCode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/FMCode.o FMCode.cpp

${OBJECTDIR}/StreamWriter.o: StreamWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/StreamWriter.o StreamWriter.cpp

${OBJECTDIR}/FMCodeFM12.o: FMCodeFM12.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/FMCodeFM12.o FMCodeFM12.cpp

${OBJECTDIR}/Bulletin.o: Bulletin.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/Bulletin.o Bulletin.cpp

${OBJECTDIR}/Helper.o: Helper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/Helper.o Helper.cpp

${OBJECTDIR}/Message.o: Message.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/Message.o Message.cpp

${OBJECTDIR}/IOException.o: IOException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/IOException.o IOException.cpp

${OBJECTDIR}/FMCodeAny.o: FMCodeAny.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/FMCodeAny.o FMCodeAny.cpp

${OBJECTDIR}/StreamReader.o: StreamReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/StreamReader.o StreamReader.cpp

${OBJECTDIR}/BulletinTAC.o: BulletinTAC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/BulletinTAC.o BulletinTAC.cpp

${OBJECTDIR}/Exception.o: Exception.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/Exception.o Exception.cpp

${OBJECTDIR}/MessageITA2.o: MessageITA2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/MessageITA2.o MessageITA2.cpp

${OBJECTDIR}/MessageAWSS.o: MessageAWSS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/MessageAWSS.o MessageAWSS.cpp

${OBJECTDIR}/MessageITA5.o: MessageITA5.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/MessageITA5.o MessageITA5.cpp

${OBJECTDIR}/Processor.o: Processor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -fast -g0 -KPIC  -o ${OBJECTDIR}/Processor.o Processor.cpp
